...
export const NICHE_CATEGORIES_LIST: NicheCategoryMeta[] = [
  { id: 'ai', name: 'AI & Copilots', icon: '⚡', query: 'ai' },
  { id: 'finance', name: 'Finance & Crypto', icon: '💰', query: 'finance' },
  { id: 'fitness', name: 'Fitness & Workout', icon: '💪', query: 'fitness' },
  { id: 'nutrition', name: 'Nutrition & Macros', icon: '🥗', query: 'nutrition' },
  { id: 'meditation', name: 'Meditation & Sleep', icon: '🧘', query: 'meditation' },
  { id: 'productivity', name: 'Productivity & Notes', icon: '✅', query: 'productivity' },
  { id: 'habits', name: 'Habits & Streaks', icon: '🌱', query: 'habits' },
  { id: 'dating', name: 'Dating & Love', icon: '❤️', query: 'dating' },
  { id: 'ecommerce', name: 'Shopping & Fashion', icon: '🛍️', query: 'ecommerce' },
  { id: 'travel', name: 'Travel & Flights', icon: '✈️', query: 'travel' },
  { id: 'food', name: 'Food Delivery', icon: '🍔', query: 'food' },
  { id: 'social', name: 'Social & Chat', icon: '💬', query: 'social' },
  { id: 'education', name: 'Education & Language', icon: '🎓', query: 'education' },
  { id: 'music', name: 'Music & Audio', icon: '🎧', query: 'music' },
  { id: 'photo', name: 'Photo & Video', icon: '📸', query: 'photo' },
  { id: 'gaming', name: 'Gaming & Esports', icon: '🎮', query: 'gaming' },
  { id: 'news', name: 'News & Magazines', icon: '📰', query: 'news' },
  { id: 'realestate', name: 'Real Estate', icon: '🏡', query: 'realestate' },
  { id: 'vpn', name: 'VPN & Privacy', icon: '🔒', query: 'vpn' },
  { id: 'health', name: 'Health & Medical', icon: '🩺', query: 'health' },
  { id: 'parenting', name: 'Baby & Parenting', icon: '👶', query: 'parenting' },
  { id: 'pets', name: 'Pet Care & Training', icon: '🐾', query: 'pets' },
  { id: 'smarthome', name: 'Smart Home & IoT', icon: '💡', query: 'smarthome' },
  { id: 'books', name: 'Books & Summaries', icon: '📚', query: 'books' },
  { id: 'weather', name: 'Weather & Outdoors', icon: '🌦️', query: 'weather' },
  { id: 'events', name: 'Events & Nightlife', icon: '🎟️', query: 'events' },
  { id: 'automotive', name: 'Auto & Mileage', icon: '🚗', query: 'automotive' },
  { id: 'mentalhealth', name: 'Mental Health & CBT', icon: '🧠', query: 'mentalhealth' },
  { id: 'astrology', name: 'Astrology & Horoscope', icon: '✨', query: 'astrology' },
  { id: 'business', name: 'Business & Invoicing', icon: '💼', query: 'business' },
  { id: 'utilities', name: 'Utilities & Scanner', icon: '🛠️', query: 'utilities' },
];
