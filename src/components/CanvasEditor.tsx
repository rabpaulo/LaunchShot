    ...
    switch (currentLayout) {
      ...
      case 'tilt-right-complement':
        return {
          ...
          phoneWrapperClass: "absolute -bottom-8 left-8 -translate-x-full rotate-12 origin-bottom-right z-10",
      ...
      case 'tilt-left-complement':
        return {
          containerClass: "relative",
          textContainerClass: `absolute top-0 left-0 w-[80%] pt-8 px-8 text-left z-20 flex flex-col items-start gap-2`,
          phoneWrapperClass: "absolute -bottom-8 right-8 translate-x-full -rotate-12 origin-bottom-left z-10",
          textAlign: "left" as const,
        };
      case 'half-right':
        return {
